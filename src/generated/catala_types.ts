/*
  Generated by atdts from type definitions in 'catala_types.atd'.
...
| { kind: 'WorkingCopyUnreadable'; value: ModuleError }
| { kind: 'WorkingCopyRecovered'; value: WorkingCopyRecovered }
...
export type WorkingCopyRecovered = {
  name: string;
  lost: string[];
}
...
export type ReplaceLosses = {
  dropped_assertions: string[];
  unset_fields: string[];
...
| { kind: 'ReplaceOriginalWithLosses'; value: ReplaceLosses }
...
export function writeTestDebugger(x: TestDebugger, context: any = x): any {
  return {
    ...
    'relative_filename': _atd_write_optional_field(_atd_write_string, x.relative_filename, x),
...
export function readTestDebugger(x: any, context: any = x): TestDebugger {
  return {
    ...
    relative_filename: _atd_read_optional_field(_atd_read_string, x['relative_filename'], x),
...
export function writeBrokenNote(x: BrokenNote, context: any = x): any {
  switch (x.kind) {
    ...
    case 'WorkingCopyUnreadable':
      return ['WorkingCopyUnreadable', writeModuleError(x.value, x)]
    case 'WorkingCopyRecovered':
      return ['WorkingCopyRecovered', writeWorkingCopyRecovered(x.value, x)]
  }
}
...
export function readBrokenNote(x: any, context: any = x): BrokenNote {
  ...
  switch (x[0]) {
    ...
    case 'WorkingCopyUnreadable':
      return { kind: 'WorkingCopyUnreadable', value: readModuleError(x[1], x) }
    case 'WorkingCopyRecovered':
      return { kind: 'WorkingCopyRecovered', value: readWorkingCopyRecovered(x[1], x) }
    default:
...
export function writeWorkingCopyRecovered(x: WorkingCopyRecovered, context: any = x): any {
  return {
    'name': _atd_write_required_field('WorkingCopyRecovered', 'name', _atd_write_string, x.name, x),
    'lost': _atd_write_required_field('WorkingCopyRecovered', 'lost', _atd_write_array(_atd_write_string), x.lost, x),
  };
}

export function readWorkingCopyRecovered(x: any, context: any = x): WorkingCopyRecovered {
  return {
    name: _atd_read_required_field('WorkingCopyRecovered', 'name', _atd_read_string, x['name'], x),
    lost: _atd_read_required_field('WorkingCopyRecovered', 'lost', _atd_read_array(_atd_read_string), x['lost'], x),
  };
}
...
export function writeReplaceLosses(x: ReplaceLosses, context: any = x): any {
  return {
    'dropped_assertions': _atd_write_required_field('ReplaceLosses', 'dropped_assertions', _atd_write_array(_atd_write_string), x.dropped_assertions, x),
    'unset_fields': _atd_write_required_field('ReplaceLosses', 'unset_fields', _atd_write_array(_atd_write_string), x.unset_fields, x),
    'dropped_tests': _atd_write_required_field('ReplaceLosses', 'dropped_tests', _atd_write_array(_atd_write_string), x.dropped_tests, x),
  };
}

export function readReplaceLosses(x: any, context: any = x): ReplaceLosses {
  return {
    dropped_assertions: _atd_read_required_field('ReplaceLosses', 'dropped_assertions', _atd_read_array(_atd_read_string), x['dropped_assertions'], x),
    unset_fields: _atd_read_required_field('ReplaceLosses', 'unset_fields', _atd_read_array(_atd_read_string), x['unset_fields'], x),
    dropped_tests: _atd_read_required_field('ReplaceLosses', 'dropped_tests', _atd_read_array(_atd_read_string), x['dropped_tests'], x),
  };
}
...
export function writeConfirmAction(x: ConfirmAction, context: any = x): any {
  switch (x.kind) {
    ...
    case 'ReplaceOriginalWithLosses':
      return ['ReplaceOriginalWithLosses', writeReplaceLosses(x.value, x)]
...
export function readConfirmAction(x: any, context: any = x): ConfirmAction {
  if (typeof x === 'string') {
    ...
    switch (x[0]) {
      case 'ReplaceOriginalWithLosses':
        return { kind: 'ReplaceOriginalWithLosses', value: readReplaceLosses(x[1], x) }
      default:
        _atd_bad_json('ConfirmAction', x, context)
        throw new Error('impossible')
    }
